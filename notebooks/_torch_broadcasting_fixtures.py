...
CASES = {'ex001': {'expression': 'a + b',
 ...
 'ex027': {'expression': 'a + b',
           ...
           'expected_compatible': True,
           'mode': 'aligned'},
 'ex028': {'expression': 'a + b',
           'intermediates': {},
           'audit': ['a', 'b'],
           'value_exprs': {},
           'expected_compatible': True,
           'mode': 'expanded'},
 'ex029': {'expression': 'scalar * vector',
           'intermediates': {},
           'audit': ['scalar', 'vector'],
           'value_exprs': {},
           'expected_compatible': True,
           'mode': 'expanded'},
 'ex030': {'expression': 'matrix + scalar',
           'intermediates': {},
           'audit': ['matrix', 'scalar'],
           'value_exprs': {},
           'expected_compatible': True,
           'mode': 'expanded'},
 'ex031': {'expression': 'matrix + vector',
           'intermediates': {},
           'audit': ['matrix', 'vector'],
           'value_exprs': {},
           'expected_compatible': True,
           'mode': 'expanded'},
 'ex032': {'expression': 'matrix + row',
           'intermediates': {},
           'audit': ['matrix', 'row'],
           'value_exprs': {},
           'expected_compatible': True,
           'mode': 'expanded'},
 'ex033': {'expression': 'matrix + column',
           'intermediates': {},
           'audit': ['matrix', 'column'],
           'value_exprs': {},
           'expected_compatible': True,
           'mode': 'expanded'},
 'ex034': {'expression': 'column + row',
           'intermediates': {},
           'audit': ['column', 'row'],
           'value_exprs': {},
           'expected_compatible': True,
           'mode': 'expanded'},
 'ex035': {'expression': 'tokens * features',
           'intermediates': {},
           'audit': ['tokens', 'features'],
           'value_exprs': {},
           'expected_compatible': True,
           'mode': 'expanded'},
 'ex036': {'expression': 'values + matrix',
           'intermediates': {},
           'audit': ['values', 'matrix'],
           'value_exprs': {},
           'expected_compatible': False,
           'mode': 'invalid'},
 'ex037': {'expression': 'a + b',
           'intermediates': {},
           'audit': ['a', 'b'],
           'value_exprs': {},
           'expected_compatible': False,
           'mode': 'invalid'},
 'ex038': {'expression': 'tokens + features',
           'intermediates': {},
           'audit': ['tokens', 'features'],
           'value_exprs': {},
           'expected_compatible': False,
           'mode': 'invalid'},
 'ex039': {'expression': 'sequence + per_batch_feature',
           'intermediates': {},
           'audit': ['sequence', 'per_batch_feature'],
           'value_exprs': {},
           'expected_compatible': False,
           'mode': 'invalid'},
 'ex040': {'expression': 'images + channels',
           'intermediates': {},
           'audit': ['images', 'channels'],
           'value_exprs': {},
           'expected_compatible': False,
           'mode': 'invalid'},
 'ex041': {'expression': 'prepared + matrix',
           'intermediates': {'prepared': 'values[:, None]'},
           'audit': ['values', 'matrix'],
           'value_exprs': {},
           'expected_compatible': True,
           'mode': 'result'},
 'ex042': {'expression': 'prepared + sequence',
           'intermediates': {'prepared': 'per_batch_feature[:, None, :]'},
           'audit': ['sequence', 'per_batch_feature'],
           'value_exprs': {},
           'expected_compatible': True,
           'mode': 'result'},
 'ex043': {'expression': 'torch.where(mask, x, y)',
           'intermediates': {},
           'audit': ['mask', 'x', 'y'],
           'value_exprs': {},
           'expected_compatible': False,
           'mode': 'invalid'},
 'ex044': {'expression': 'activations + bias',
           'intermediates': {},
           'audit': ['activations', 'bias'],
           'value_exprs': {},
           'expected_compatible': True,
           'mode': 'basic'},
 'ex045': {'expression': 'offset_view + activations',
           'intermediates': {'offset_view': 'offset[:, None]'},
           'audit': ['activations', 'offset'],
           'value_exprs': {},
           'expected_compatible': True,
           'mode': 'result'},
 'ex046': {'expression': 'tokens + positions',
           'intermediates': {},
           'audit': ['tokens', 'positions'],
           'value_exprs': {},
           'expected_compatible': True,
           'mode': 'basic'},
 'ex047': {'expression': 'mask_view * embeddings',
           'intermediates': {'mask_view': 'mask[:, :, None]'},
           'audit': ['mask', 'embeddings'],
           'value_exprs': {},
           'expected_compatible': True,
           'mode': 'result'},
 'ex048': {'expression': 'losses * class_weights',
           'intermediates': {},
           'audit': ['losses', 'class_weights'],
           'value_exprs': {},
           'expected_compatible': True,
           'mode': 'basic'},
 'ex049': {'expression': 'bias_view + images',
           'intermediates': {'bias_view': 'bias[None, :, None, None]'},
           'audit': ['images', 'bias'],
           'value_exprs': {},
           'expected_compatible': True,
           'mode': 'result'},
 'ex050': {'expression': 'scores.masked_fill(~mask, -1e9)',
           'intermediates': {'inverted_mask': '~mask'},
           'audit': ['scores', 'mask'],
           'value_exprs': {},
           'expected_compatible': True,
           'mode': 'basic'},
 'ex051': {'expression': 'x_rows - y_rows',
           'intermediates': {'x_rows': 'x[:, None, :]', 'y_rows': 'y[None, :, :]'},
           'audit': ['x', 'y'],
           'value_exprs': {},
           'expected_compatible': True,
           'mode': 'result'},
 'ex052': {'expression': 'source.expand_as(target)',
           'intermediates': {},
           'audit': ['source', 'target'],
           'value_exprs': {},
           'expected_compatible': True,
           'mode': 'result'},
 'ex053': {'expression': 'torch.broadcast_to(source, target.shape)',
           'intermediates': {},
           'audit': ['source', 'target'],
           'value_exprs': {},
           'expected_compatible': True,
           'mode': 'result'},
 'ex054': {'expression': 'source.repeat(2, 1)',
           'intermediates': {},
           'audit': ['source'],
           'value_exprs': {},
           'expected_compatible': True,
           'mode': 'result'},
 'ex055': {'expression': 'source.expand(2, 3)',
           'intermediates': {},
           'audit': ['source'],
           ...
           'expected_compatible': True,
           'mode': 'storage'},
 'ex056': {'expression': 'source.expand(2, 3).clone()',
           'intermediates': {},
           'audit': ['source'],
           'value_exprs': {'shares_storage': 'out.untyped_storage().data_ptr() == '
                                             'source.untyped_storage().data_ptr()'},
 ...
 'ex057': {'expression': 'normalized',
           ...
           'expected_compatible': True,
           'mode': 'capstone'},
 'ex058': {'expression': 'masked_scores',
...
PRE_OPERATOR_GROUPS = {'ex009': [('a_before_op', 'a'), ('b_before_op', 'b')],
 ...
 'ex026': [('tokens_before_op', 'tokens'), ('plane_before_op', 'plane')],
 'ex027': [('a_before_op', 'a'), ('b_before_op', 'b')],
 'ex028': [('a_before_op', 'a'), ('b_before_op', 'b')],
 'ex029': [('scalar_before_op', 'scalar'), ('vector_before_op', 'vector')],
 'ex030': [('matrix_before_op', 'matrix'), ('scalar_before_op', 'scalar')],
 'ex031': [('matrix_before_op', 'matrix'), ('vector_before_op', 'vector')],
 'ex032': [('matrix_before_op', 'matrix'), ('row_before_op', 'row')],
 'ex033': [('matrix_before_op', 'matrix'), ('column_before_op', 'column')],
 'ex034': [('column_before_op', 'column'), ('row_before_op', 'row')],
 'ex035': [('tokens_before_op', 'tokens'), ('features_before_op', 'features')],
 'ex047': [('mask_view_before_op', 'mask_view'), ('embeddings_before_op', 'embeddings')],
 'ex050': [('scores_before_op', 'scores'), ('inverted_mask_before_op', 'inverted_mask')],
 'ex051': [('x_rows_before_op', 'x_rows'), ('y_rows_before_op', 'y_rows')]}
