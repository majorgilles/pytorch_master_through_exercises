...
CASES = {'ex001': {'expression': 'a + b',
 ...
 'ex027': {'expression': 'a + b',
           ...
           'expected_compatible': True,
           'mode': 'aligned'},
 'ex028': {'expression': 'images * width_scale',
           'intermediates': {},
           'audit': ['images', 'width_scale'],
           'value_exprs': {},
           'expected_compatible': True,
           'mode': 'expanded'},
 'ex029': {'expression': 'values + matrix',
           'intermediates': {},
           'audit': ['values', 'matrix'],
           'value_exprs': {},
           'expected_compatible': False,
           'mode': 'invalid'},
 'ex030': {'expression': 'a + b',
           'intermediates': {},
           'audit': ['a', 'b'],
           'value_exprs': {},
           'expected_compatible': False,
           'mode': 'invalid'},
 'ex031': {'expression': 'images + width_offsets',
           'intermediates': {},
           'audit': ['images', 'width_offsets'],
           'value_exprs': {},
           'expected_compatible': False,
           'mode': 'invalid'},
 'ex032': {'expression': 'images + per_image_width_offset',
           'intermediates': {},
           'audit': ['images', 'per_image_width_offset'],
           'value_exprs': {},
           'expected_compatible': False,
           'mode': 'invalid'},
 'ex033': {'expression': 'images + channels',
           'intermediates': {},
           'audit': ['images', 'channels'],
           'value_exprs': {},
           'expected_compatible': False,
           'mode': 'invalid'},
 'ex034': {'expression': 'prepared + matrix',
           'intermediates': {'prepared': 'values[:, None]'},
           'audit': ['values', 'matrix'],
           'value_exprs': {},
           'expected_compatible': True,
           'mode': 'result'},
 'ex035': {'expression': 'prepared + images',
           'intermediates': {'prepared': 'per_image_width_offset[:, None, :]'},
           'audit': ['images', 'per_image_width_offset'],
           'value_exprs': {},
           'expected_compatible': True,
           'mode': 'result'},
 'ex036': {'expression': 'torch.where(mask, x, y)',
           'intermediates': {},
           'audit': ['mask', 'x', 'y'],
           'value_exprs': {},
           'expected_compatible': False,
           'mode': 'invalid'},
 'ex037': {'expression': 'activations + bias',
           'intermediates': {},
           'audit': ['activations', 'bias'],
           'value_exprs': {},
           'expected_compatible': True,
           'mode': 'basic'},
 'ex038': {'expression': 'offset_view + activations',
           'intermediates': {'offset_view': 'offset[:, None]'},
           'audit': ['activations', 'offset'],
           'value_exprs': {},
           'expected_compatible': True,
           'mode': 'result'},
 'ex039': {'expression': 'tokens + positions',
           'intermediates': {},
           'audit': ['tokens', 'positions'],
           'value_exprs': {},
           'expected_compatible': True,
           'mode': 'basic'},
 'ex040': {'expression': 'mask_view * embeddings',
           'intermediates': {'mask_view': 'mask[:, :, None]'},
           'audit': ['mask', 'embeddings'],
           'value_exprs': {},
           'expected_compatible': True,
           'mode': 'result'},
 'ex041': {'expression': 'losses * class_weights',
           'intermediates': {},
           'audit': ['losses', 'class_weights'],
           'value_exprs': {},
           'expected_compatible': True,
           'mode': 'basic'},
 'ex042': {'expression': 'bias_view + images',
           'intermediates': {'bias_view': 'bias[None, :, None, None]'},
           'audit': ['images', 'bias'],
           'value_exprs': {},
           'expected_compatible': True,
           'mode': 'result'},
 'ex043': {'expression': 'scores.masked_fill(~mask, -1e9)',
           'intermediates': {'inverted_mask': '~mask'},
           'audit': ['scores', 'mask'],
           'value_exprs': {},
           'expected_compatible': True,
           'mode': 'basic'},
 'ex044': {'expression': 'x_rows - y_rows',
           'intermediates': {'x_rows': 'x[:, None, :]', 'y_rows': 'y[None, :, :]'},
           'audit': ['x', 'y'],
           'value_exprs': {},
           'expected_compatible': True,
           'mode': 'result'},
 'ex045': {'expression': 'source.expand_as(target)',
           'intermediates': {},
           'audit': ['source', 'target'],
           'value_exprs': {},
           'expected_compatible': True,
           'mode': 'result'},
 'ex046': {'expression': 'torch.broadcast_to(source, target.shape)',
           'intermediates': {},
           'audit': ['source', 'target'],
           'value_exprs': {},
           'expected_compatible': True,
           'mode': 'result'},
 'ex047': {'expression': 'source.repeat(2, 1)',
           'intermediates': {},
           'audit': ['source'],
           'value_exprs': {},
           'expected_compatible': True,
           'mode': 'result'},
 'ex048': {'expression': 'source.expand(2, 3)',
           'intermediates': {},
           'audit': ['source'],
           ...
           'expected_compatible': True,
           'mode': 'storage'},
 'ex049': {'expression': 'source.expand(2, 3).clone()',
           'intermediates': {},
           'audit': ['source'],
           'value_exprs': {'shares_storage': 'out.untyped_storage().data_ptr() == '
                                             'source.untyped_storage().data_ptr()'},
 ...
 'ex050': {'expression': 'normalized',
           ...
           'expected_compatible': True,
           'mode': 'capstone'},
 'ex051': {'expression': 'masked_scores',
...
PRE_OPERATOR_GROUPS = {'ex009': [('a_before_op', 'a'), ('b_before_op', 'b')],
 ...
 'ex040': [('mask_view_before_op', 'mask_view'), ('embeddings_before_op', 'embeddings')],
 'ex043': [('scores_before_op', 'scores'), ('inverted_mask_before_op', 'inverted_mask')],
 'ex044': [('x_rows_before_op', 'x_rows'), ('y_rows_before_op', 'y_rows')]}
